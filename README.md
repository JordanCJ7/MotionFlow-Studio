...
*   **🛠️ Compact Multi-Tool Media Suite**: A consolidated desktop dashboard featuring nine distinct media tools:
    ...
    *   **AI Bg Remover**: Neural network background removal (`@imgly/background-removal`) + instant offline color keying, sticker stroke outline effects, and transparent PNG/GIF exports.
    *   **Frame Extractor**: Decompose any animated GIF into individual PNG/JPEG/WebP frames with frame duration metadata and one-click ZIP package export.
